...
/**
 * struct passinfo - Parameters for functions
 ...
 * @linecount_flag: Set to count this line of input
 ...
 * @env_changed: Set if environment variables were changed
 * @status: Return status of the last executed command
 * @cmd_buf: Address of the pointer to cmd_buf, used for chaining
